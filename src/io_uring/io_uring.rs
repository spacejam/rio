...
fn bindgen_test_layout_io_sqring_offsets() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<io_sqring_offsets>()))
...
fn bindgen_test_layout_io_cqring_offsets() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<io_cqring_offsets>()))
                .head as *const _ as usize
        },
        0usize,
        concat!(
